/****************************************************************************
 * boards/arm/stm32/stm32f411-weact/src/stm32_w25.c
 *
...
int stm32_w25initialize(int minor)
{
  ...
  const char *partname = CONFIG_STM32F411WEACT_FLASH_PART_NAMES;
#endif
  ...
  smart_initialize(CONFIG_STM32F411WEACT_FLASH_MINOR, mtd, NULL);
