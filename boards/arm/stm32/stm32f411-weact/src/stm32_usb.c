/****************************************************************************
 * boards/arm/stm32/stm32f411-weact/src/stm32_usb.c
 *
...
#ifndef CONFIG_STM32F411WEACT_USBHOST_PRIO
#  define CONFIG_STM32F411WEACT_USBHOST_PRIO 100
#endif

#ifndef CONFIG_STM32F411WEACT_USBHOST_STACKSIZE
#  define CONFIG_STM32F411WEACT_USBHOST_STACKSIZE 1024
#endif
  ...
  if (g_usbconn)
    {
      ...
      ret = kthread_create("usbhost", CONFIG_STM32F411WEACT_USBHOST_PRIO,
                           CONFIG_STM32F411WEACT_USBHOST_STACKSIZE,
                           usbhost_waiter, NULL);
